                        ...
                        <form action="<?= BASE_URL . 'dangnhap' ?>" method="post" class="w-3/6 m-auto form" id="form-1">
                            ...
                            <div class="form-group">
                                <label for="tendangnhap"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Name login</label>
                                <input id="tendangnhap" type="text" name="user" id="password"
                            ...
                            <div class="form-group">
                                <label for="password"
                                    class="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Passowrd</label>
                                <input id="password" type="password" name="pass" id="repeat-password"
                                    class="form-control shadow-sm bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500 dark:shadow-sm-light"
                            ...
                            <input
                                ...
                                type="submit" value="Login" name="dangnhap" />

                            <a class="w-full text-white text-center block bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
                                href="<?= BASE_URL . 'form-dangky' ?>">Register</a>
                            <li class="hover:text-blue-700 hover:underline w-1/6"><a
                                    href="<?= BASE_URL . 'form-quenmk' ?>">Quên mật khẩu</a></li>
